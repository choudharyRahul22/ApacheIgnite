 ...
 */
public class MySQLDBStore extends CacheStoreAdapter<String, Post> implements LifecycleAware {
    @Autowired
    ...
    public void start() throws IgniteException {
        ConfigurableApplicationContext context = new ClassPathXmlApplicationContext("mysql-context.xml");
